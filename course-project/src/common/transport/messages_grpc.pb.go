...
type WeatherServiceClient interface {
	...
	ListRequests(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListRequestsResponse, error)
}
...
func (c *weatherServiceClient) GetCurrentWeather(ctx context.Context, in *CurrentWeatherRequest, opts ...grpc.CallOption) (*CurrentWeatherResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/WeatherService/GetCurrentWeather", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *weatherServiceClient) ListRequests(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListRequestsResponse, error) {
	out := new(ListRequestsResponse)
	err := c.cc.Invoke(ctx, "/WeatherService/ListRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	...
	ListRequests(context.Context, *EmptyRequest) (*ListRequestsResponse, error)
...
func (UnimplementedWeatherServiceServer) ListRequests(context.Context, *EmptyRequest) (*ListRequestsResponse, error) {
...
func _WeatherService_GetCurrentWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/WeatherService/GetCurrentWeather",
	}
...
func _WeatherService_ListRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).ListRequests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/WeatherService/ListRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ListRequests(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WeatherService_ListRequests_Handler,
		},
	},
